...
// 📌 ปรับ Scale (ลดระยะซูม) และ Center ให้แต่ละภาคแสดงผลพอดีกรอบ
export const regionsConfig: Record<string, { center: [number, number]; scale: number; provinces: string[] }> = {
  "ภาคเหนือ": { center: [99.5, 18.5], scale: 7000, provinces: ["เชียงราย", "เชียงใหม่", "น่าน", "พะเยา", "แพร่", "แม่ฮ่องสอน", "ลำปาง", "ลำพูน", "อุตรดิตถ์"] },
  "ภาคอีสาน": { center: [103.5, 16.0], scale: 6000, provinces: ["กาฬสินธุ์", "ขอนแก่น", "ชัยภูมิ", "นครพนม", "นครราชสีมา", "บึงกาฬ", "บุรีรัมย์", "มหาสารคาม", "มุกดาหาร", "ยโสธร", "ร้อยเอ็ด", "เลย", "สกลนคร", "สุรินทร์", "ศรีสะเกษ", "หนองคาย", "หนองบัวลำภู", "อุดรธานี", "อุบลราชธานี", "อำนาจเจริญ"] },
  "ภาคกลาง": { center: [100.5, 15.2], scale: 5000, provinces: ["กรุงเทพฯ", "กำแพงเพชร", "ชัยนาท", "นครนายก", "นครปฐม", "นครสวรรค์", "นนทบุรี", "ปทุมธานี", "อยุธยา", "พิจิตร", "พิษณุโลก", "เพชรบูรณ์", "ลพบุรี", "สมุทรปราการ", "สมุทรสงคราม", "สมุทรสาคร", "สระบุรี", "สิงห์บุรี", "สุโขทัย", "สุพรรณบุรี", "อ่างทอง", "อุทัยธานี"] },
  "ภาคตะวันออก": { center: [101.8, 13.5], scale: 8000, provinces: ["จันทบุรี", "ฉะเชิงเทรา", "ชลบุรี", "ตราด", "ปราจีนบุรี", "ระยอง", "สระแก้ว"] },
  "ภาคตะวันตก": { center: [99.0, 14.2], scale: 4800, provinces: ["กาญจนบุรี", "ตาก", "ประจวบฯ", "เพชรบุรี", "ราชบุรี"] },
  "ภาคใต้": { center: [99.5, 8.5], scale: 4000, provinces: ["กระบี่", "ชุมพร", "ตรัง", "นครศรีธรรมราช", "นราธิวาส", "ปัตตานี", "พังงา", "พัทลุง", "ภูเก็ต", "ยะลา", "ระนอง", "สงขลา", "สตูล", "สุราษฎร์ธานี"] }
};
...
export const generateInitialData = () => {
  ...
  allProvinceNames.forEach(province => {
    // 📌 จุดที่แก้ไข: ล็อคให้แม่ฮ่องสอนเป็น "ยังไม่บริจาค" ตลอดเวลา
    if (province === "แม่ฮ่องสอน") {
